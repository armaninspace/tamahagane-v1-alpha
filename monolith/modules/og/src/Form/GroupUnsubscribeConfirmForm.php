...
class GroupUnsubscribeConfirmForm extends ContentEntityDeleteForm {
  ...
  public function getDescription() {
    return t('Are you sure you want to Unsubscribe this group ?');
  }
  /**
   * {@inheritdoc}
   */
  public function getCancelUrl() {
    ...
    return $group->access('view') ? Url::fromRoute('<front>') : Url::fromRoute('<front>');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $redirect = $group->access('view') ? Url::fromRoute('<front>') : Url::fromRoute('<front>');
