<?php
namespace Drupal\tm_rankingplot\Controller;
...
/**
 * Class RankingplotController.
 *
 * @package Drupal\tm_rankingplot\Controller
 */
class RankingplotController extends ControllerBase {
  public function addForm() {
	...
	$path =  drupal_get_path('module', 'tm_rankingplot');
	$module_path = $droot.'/'.$path;
	$template = $twig->loadTemplate($path.'/templates/tm_rankingplot_form.html.twig');
