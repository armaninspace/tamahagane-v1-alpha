<?php
namespace Drupal\tm_cmatrix\Controller;
...
/**
 * Class Correlation Matrix Controller.
 *
 * @package Drupal\tm_cmatrix\Controller
 */
class CmatrixController extends ControllerBase {
  public function addForm() {
    ...
    $path =  drupal_get_path('module', 'tm_cmatrix');
    $template = $twig->loadTemplate($path.'/templates/tm_cmatrix_form.html.twig');
  ...
  public function processData() {
    ...
    if ($chart_type == "cmatrixchart") {
      ...
      if ($res_a['nrows_for_plot_after_filter'] === FALSE) {
        //$resp_alert_error .= '<strong>No. of rows in dataset after implementing filter: </strong>' . $res_a['nrows_after_filter'] . '<br/>';
        $resp_alert_error .= '<strong>'.$res_a['nrows_message'].' </strong><br/>';
      }
