<?php
namespace Drupal\tm_linechart\Controller;
 ...
 *
 * @package Drupal\tm_linechart\Controller
 */
class LinechartController extends ControllerBase {
  public function addForm() {
	...
	$path =  drupal_get_path('module', 'tm_linechart');
	$module_path = $droot.'/'.$path;
	$template = $twig->loadTemplate($path.'/templates/tm_linechart_form.html.twig');
  ...
  public function processData() {
    ...
    $rfile_path = 'linechart.R';
    $rdir_name = '/rcodes_plotly';/*** Plotly ***/
    $droot = \Drupal::root();
    $path_to_module = drupal_get_path('module', 'tm_linechart');
