<?php
namespace Drupal\tm_spmatrix\Controller;
...
/**
 * Class SpmatrixController.
 *
 * @package Drupal\tm_spmatrix\Controller
 */
class SpmatrixController extends ControllerBase {
  public function addForm() {
    ...
    $path =  drupal_get_path('module', 'tm_spmatrix');
    $template = $twig->loadTemplate($path.'/templates/tm_spmatrix_form.html.twig');
  ...
  public function processData() {
    ...
    if ($chart_type == "spmatrixchart") {
      ...
      elseif ($res_a['nrows_after_contains_filter'] === FALSE) {
        ...
        $resp_alert_success .= '<strong>No. of rows in dataset after implementing filters: </strong>' . $res_a['nrows_after_contains_filter_int'] . '<br/>';
        $resp_alert_error .= '<strong>Need at least 4 points to generate chart.</strong><br/>';
      }
