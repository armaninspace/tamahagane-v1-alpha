<?php
namespace Drupal\tm_clusteranalysis\Controller;
 ...
 *
 * @package Drupal\tm_clusteranalysis\Controller
 */
class ClusteranalysisController extends ControllerBase {
  public function addForm() {
    ...
    $path =  drupal_get_path('module', 'tm_clusteranalysis');
    $module_path = $droot.'/'.$path;
    $template = $twig->loadTemplate($path.'/templates/tm_clusteranalysis_form.html.twig');
  ...
  public function processData() {
    ...
    $rfile_path = 'cluster_analysis.R';
    $rdir_name = '/rcodes_plotly';/*** Plotly ***/
    $droot = \Drupal::root();
    $path_to_module = drupal_get_path('module', 'tm_clusteranalysis');
