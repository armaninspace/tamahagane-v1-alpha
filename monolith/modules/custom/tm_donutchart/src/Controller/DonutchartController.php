<?php
namespace Drupal\tm_donutchart\Controller;
 ...
 *
 * @package Drupal\tm_donutchart\Controller
 */
class DonutchartController extends ControllerBase {
  public function addForm() {
	...
	$path =  drupal_get_path('module', 'tm_donutchart');
	$module_path = $droot.'/'.$path;
	$template = $twig->loadTemplate($path.'/templates/tm_donutchart_form.html.twig');
  ...
  public function processData() {
	...
	$droot = \Drupal::root();
	$path_to_module = drupal_get_path('module', 'tm_donutchart');
