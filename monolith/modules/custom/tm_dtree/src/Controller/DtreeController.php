<?php
namespace Drupal\tm_dtree\Controller;
...
/**
 * Class DtreeController.
 *
 * @package Drupal\tm_dtree\Controller
 */
class DtreeController extends ControllerBase {
  public function addForm() {
	...
	$path =  drupal_get_path('module', 'tm_dtree');
	$template = $twig->loadTemplate($path.'/templates/tm_dtree_form.html.twig');
  ...
  public function processData() {
	...
	$droot = \Drupal::root();
	$droot = str_replace("\\", "/", $droot);
	$path_to_module = drupal_get_path('module', 'tm_dtree');
