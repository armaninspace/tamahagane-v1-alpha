<?php
namespace Drupal\tm_heatmap\Controller;
 ...
 *
 * @package Drupal\tm_heatmap\Controller
 */
class HeatmapController extends ControllerBase {
  public function addForm() {
    ...
    $path =  drupal_get_path('module', 'tm_heatmap');
    $template = $twig->loadTemplate($path.'/templates/tm_heatmap_form.html.twig');
