<?php
namespace Drupal\tm_surfacechart\Controller;
...
/**
 * Class SurfacechartController.
 *
 * @package Drupal\tm_surfacechart\Controller
 */
class SurfacechartController extends ControllerBase {
  /**
   * Hello.
   *
   * @return string
  ...
  public function addForm() {
	...
	$path =  drupal_get_path('module', 'tm_surfacechart');
	$template = $twig->loadTemplate($path.'/templates/tm_surfacechart_form.html.twig');
  ...
  public function processData() {
	...
	$rfile_path = 'surfacechart.R';
	$rdir_name = '/rcodes_plotly';/*** Plotly ***/
	$droot = \Drupal::root();
	$path_to_module = drupal_get_path('module', 'tm_surfacechart');
