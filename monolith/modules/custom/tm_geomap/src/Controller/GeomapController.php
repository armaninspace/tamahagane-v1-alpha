<?php
namespace Drupal\tm_geomap\Controller;
 ...
 *
 * @package Drupal\tm_geomap\Controller
 */
class GeomapController extends ControllerBase {
  public function addForm() {
    ...
    $path =  drupal_get_path('module', 'tm_geomap');
    $module_path = $droot.'/'.$path;
    $template = $twig->loadTemplate($path.'/templates/tm_geomap_form.html.twig');
  ...
  public function processData() {
    ...
    $rfile_path = 'geovisualization.R';
    $rdir_name = '/rcodes_plotly';/*** Plotly ***/
    $droot = \Drupal::root();
    $path_to_module = drupal_get_path('module', 'tm_geomap');
