<?php
namespace Drupal\tm_histogram\Controller;
 ...
 *
 * @package Drupal\tm_histogram\Controller
 */
class HistogramController extends ControllerBase {
  public function addForm() {
   ...
   //$file_path = "/mnt/www/beta-03.tamahagane.org/htdocs/modules/custom/tm_analytics/data_files/4385026e-8ab6-46b1-83e2-257c4d1c8946.csv";
	...
	$path =  drupal_get_path('module', 'tm_histogram');
	$template = $twig->loadTemplate($path.'/templates/tm_histogram_form.html.twig');
  ...
  public function processData() {
    ...
    $rfile_path = 'histogram.R';
    $rdir_name = '/rcodes_plotly';/*** Plotly ***/
    $droot = \Drupal::root();
    $path_to_module = drupal_get_path('module', 'tm_histogram');
    ...
    if ($chart_type == "histogram") {
      ...
      else if ($res_a['csv_load_status'] === FALSE) {
      ...
      else if ($res_a['nrows_after_numeric_filter'] === FALSE) {
