<?php
namespace Drupal\tm_barchart\Controller;
...
/**
 * Class Barchart Controller.
 *
 * @package Drupal\tm_barchart\Controller
 */
class BarchartController extends ControllerBase {
  public function addForm() {
    ...
    $path =  drupal_get_path('module', 'tm_barchart');
    $template = $twig->loadTemplate($path.'/templates/tm_barchart_form.html.twig');
  ...
  public function processData() {
    ...
    $rfile_path = 'barchart.R';
    $rdir_name = '/rcodes_plotly';
    $droot = \Drupal::root();
    $path_to_module = drupal_get_path('module', 'tm_barchart');
