<?php
namespace Drupal\tm_biplot\Controller;
...
/**
 * Class BiplotController.
 *
 * @package Drupal\tm_biplot\Controller
 */
class biplotController extends ControllerBase {
  public function addForm() {
	...
	$path =  drupal_get_path('module', 'tm_biplot');
	$template = $twig->loadTemplate($path.'/templates/tm_biplot_form.html.twig');
	$response['form_html'] = $template->render(['img_dir' => $img_dir,'num_fields'=>$int_num_fields, 'merged_fields'=>$saved_allFields,'factorNlogical'=>$factorNlogical]);
  ...
  public function processData() {
	...
	if ($chart_type == "biplot") {
	  ...
	  if ($output) {
		...
		$resp .= '<div id="htmlwidget_container" class="bi_plot"><div id="' . $generated_id . '" class="plotly html-widget"></div></div>';
		$resp .= $script_one;
